...
- **Creation of the guide:** The script should create a narration guide ([NARRATION_GUIDE]) based on the `state` ([RP_STATE]) and the LLM's summary ([NARRATION_SUMMARY]). This guide contains two parts:
